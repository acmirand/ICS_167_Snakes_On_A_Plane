...
var game_state =
{
    ...
    get: function (x, y) { // Retrieves the value found in the game board array.
...
var p1_snake = // Class of p1_snake
{
    ...
    insert: function (x, y) { 
        this._snake_array.unshift({ x: x, y: y }); // Puts the x and y coordinate to the front of the array.
